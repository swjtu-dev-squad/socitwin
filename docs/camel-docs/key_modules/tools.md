...
For more detailed end-to-end examples, refer to the upstream CAMEL examples and
online documentation. The large cookbook set is intentionally not vendored in
this repository.
