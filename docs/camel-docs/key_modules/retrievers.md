...
<Tip>
This trimmed snapshot keeps the API and concept docs only. For larger RAG
walkthroughs, use the upstream CAMEL online documentation.
</Tip>
...
<CardGroup cols={2}>
  <Card
    title="Upstream RAG Examples"
    icon="rocket"
    href="https://docs.camel-ai.org"
  >
    Use the official CAMEL docs for full retrieval-augmented examples.
  </Card>
  <Card
    title="Reference API"
    icon="book"
