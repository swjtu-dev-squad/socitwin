...
<CardGroup cols={2}>
  <Card
    ...
    icon="users"
    href="https://github.com/camel-ai/camel/tree/master/examples"
  >
    Explore the upstream CAMEL examples repository for end-to-end agent samples.
  </Card>
  <Card
    title="Explore Upstream Cookbooks"
    icon="bookmark"
    href="https://docs.camel-ai.org"
  >
    The large cookbook collection is intentionally not vendored in this repository.
  </Card>
  <Card
