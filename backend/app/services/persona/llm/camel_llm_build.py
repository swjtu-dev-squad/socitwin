...
from .camel_runtime_spec import ModelRuntimeSpec, ResolvedModelRuntime
from .heuristic_tokens import HeuristicUnicodeTokenCounter

logger = logging.getLogger(__name__)


def build_shared_model(spec: ModelRuntimeSpec | list[ModelRuntimeSpec]) -> ResolvedModelRuntime:
    ...
    model = backends[0] if len(backends) == 1 else ModelManager(backends, scheduling_strategy="round_robin")
