...
export default function Analytics() {
  ...
  const informationVelocity = useMemo(() => {
    ...
    const trendPercent = prevVelocity > 0 ? ((velocity - prevVelocity) / prevVelocity) * 100 : 0
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div
                    className={cn(
                      ...
                      m.disabled
                        ...
                        : 'bg-bg-primary border-border-default group-hover:border-border-strong'
                    )}
                  >
            ...
            <Card className="md:col-span-2 lg:col-span-3 p-6 bg-bg-secondary border-border-default flex flex-col h-[400px]">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  <Badge
                    variant="outline"
                    className="bg-rose-500/10 border-rose-500/20 text-rose-500 text-[10px]"
                  >
                    实时监控
                  </Badge>
                </div>
            ...
            <Card className="md:col-span-2 lg:col-span-3 p-6 bg-bg-secondary border-border-default flex flex-col h-[400px]">
              <div className="flex justify-between items-center mb-6">
                ...
                <Badge
                  variant="outline"
                  className="bg-emerald-500/10 border-emerald-500/20 text-emerald-500 text-[10px]"
                >
                  实时监控
                </Badge>
              </div>
            ...
            <Card className="md:col-span-2 lg:col-span-3 p-6 bg-bg-secondary border-border-default flex flex-col h-[400px]">
              <div className="flex justify-between items-center mb-6">
                ...
                <Badge
                  variant="outline"
                  className="bg-blue-500/10 border-blue-500/20 text-blue-500 text-[10px]"
                >
                  行为集中度
                </Badge>
              </div>
